...
> **상태: v1.18.0 운영 중** — 마일리지 코어(Phase 1), 외부 학습 앱 자동 적립 연동(Phase 2), PC 사용시간 가드(Phase 3), 안드로이드 앱·FCM 푸시, 공지사항·가족 채팅까지 동작한다.
...
| Phase 3 | 사용권 기기 자동 적용 (PC 세션 가드, 비정상 종료 알림) | ✅ 코어 완료 (v1.9.0) |
